...
const policies = [
  {
    ...
    content: `يمكنك طلب استبدال المنتج بمقاس مختلف (أكبر أو أصغر) عن طريق التواصل معنا.\n\nيتحمل العميل مصاريف شحن عملية الاستبدال ذهابًا وعودة.\n\nإذا طُلب الاستبدال بعد استلام الطلب لأي سبب، سيتم احتساب مصاريف شحن جديدة على العميل.`
  },
  {
    title: 'سياسة الإرجاع',
    content: `لا يتم قبول الإرجاع بعد استلام الطلب.\n\nفي حال وجود أي مشكلة في المنتج بعد التسليم، يمكنك التواصل معنا وسنقوم بمساعدتك عبر الاستبدال، مع تحمّل العميل مصاريف الشحن الخاصة بذلك.`
  },
  {
    title: 'سياسة الفحص والاستلام',
    content: `يحق للعميل فحص الطلب أمام المندوب قبل الاستلام.\n\nلا يُسمح بالقبول الجزئي للطلب — إذا كان الطلب يحتوي على أكثر من منتج، يجب قبوله أو رفضه بالكامل.\n\nفي حال رغبة العميل بمعاينة المنتج قبل الدفع، يتم إضافة رسوم معاينة إضافية قدرها 50 جنيهًا على قيمة الطلب.`
  },
];
